...
var helper = _interopRequireWildcard(_OverlayViewHelper);
...
exports.default = (0, _flowRight3.default)(_react2.default.createClass, (0, _enhanceElement2.default)(getInstanceFromComponent, publicMethodMap, eventMap, controlledPropUpdaterMap))({
  ...
  onAdd: function onAdd() {
    this._containerElement = helper.createContainerElement();
  },
  draw: function draw() {
    // https://developers.google.com/maps/documentation/javascript/3.exp/reference#OverlayView
    ...
    helper.mountContainerElementToPane(mapPanes, this._containerElement, props);
    helper.renderChildToContainerElement(mapCanvasProjection, this._containerElement, props);
  },
  onRemove: function onRemove() {
    helper.unmountAndDestroyContainerElement(this._containerElement);
